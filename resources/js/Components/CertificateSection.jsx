...
const CertificateSection = () => {
    ...
    return (
        <section className="bg-gray-50">
            <div className="py-16 max-w-7xl mx-auto px-4 sm:px-6 xl:px-0 mb-24">
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        >
                            ANSI/TIA-942-B-2017 <span className="text-blue-600 font-bold">RATED-3</span>
                        </motion.p>
                    </motion.div>
                ...
                >
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            whileHover={{ scale: 1.05 }}
                            className="flex flex-col items-center justify-center text-center gap-4 p-4 bg-white rounded-lg w-full"
                        >
                            <motion.h3
