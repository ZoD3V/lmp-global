                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-gray-600">
                                    ...
                                    temperature distribution insights, allowing
                                    an intuitive understanding of thermal
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">
                                    Evaluate heat maps and thermal data before
                                    implementation on-site, making informed
                                    decisions during server rack additions or
                                    decommissioning and adjusting cooling
                                    control policies.
                                </p>
                            </div>
                            <div>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400">
                                        Display essential metrics like PUE, CUE,
                                        cooling load, IT load, individual.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400">
                                        ...
                                        day-to-day decision-making for optimal
                                        energy management.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400">
                                        Seamlessly integrates with Data Center
                                        Infrastructure Management (DCIM) for
                                        live data retrieval and accurate
                                        real-time insights.
                                    </p>
                                </div>
                            </div>
