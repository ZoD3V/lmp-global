...
const EdgeDcMonitoring = ({ monitorings }) => {
    return (
        <section className="py-16 w-full">
            <div className="container px-4 md:px-6 xl:px-0 max-w-[1200px] flex flex-col gap-12">
                <Heading
                    title={"EDGE DC Monitoring "}
                    customParagraph="w-full mt-2"
                    description={
                        "EDGE Data Center Web Dashboard Monitoring is an integrated platform designed to monitor all EDGE Data Center units spread across various locations in Indonesia in real time. This dashboard displays visualization of operational status such as temperature, humidity, power consumption, physical access, security systems, and network availability, all in one easy-to-use interface."
                    }
                />
...
export default EdgeDcMonitoring;
